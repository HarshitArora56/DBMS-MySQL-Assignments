...
alter table products modify column product_id int auto_increment, auto_increment = 1001;
show columns from employees;
insert into products (product_name, price) values ("Mobile", 10000), ("Laptop", 50000);
...
insert into employees values (1, "Harshit", "Arora", 22, 1000, null); -- error due to check constraint violation
insert into employees values (1, "Harshit", "Arora", 22, 2000, null);
...
alter table employees drop key fk_department;
show create table employees;
alter table employees add constraint fk_department foreign key (department_id) references departments(department_id);
