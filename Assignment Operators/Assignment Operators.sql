create database assignmentOperators;
use assignmentOperators;
...
select job_id, max(salary) as max_salary from employees group by job_id having max(salary) <= 20000 order by max_salary desc;
...
select job_id, max(salary) as max_salary from employees group by job_id having max_salary >= 10000 order by max_salary desc;
...
select job_id, min(salary) as min_salary from employees group by job_id having min(salary) > 6000 order by min_salary desc;  
...
select job_id,department_id from employees where department_id not in(60,70,80);

-- 27.	Write a query to display job titles where the minimum salary is not less than 5000.
select job_id, min(salary) as min_salary from employees group by job_id having min(salary) >= 5000 order by min_salary desc;

-- 28.	Write a query to find employees whose department ID is not equal to 100 or 60.
select * from employees where department_id <> 100 or department_id <> 60;
...
select job_id, min(salary) as min_salary, max(salary) as max_salary from employees group by job_id having min(salary) < 5000 or max(salary) > 20000; 

-- 33.	Write a query to display employees where SALARY is greater than 6000 and DEPARTMENT_ID is either 50 or 60.
select * from employees where salary > 6000 and (department_id = 50 or department_id = 60);
...
select * from employees where salary not between 3000 and 10000 order by salary asc;

-- 42.	Write a query to display employees whose salary is greater than 6000 and COMMISSION_PCT is null or less than 0.2.
select * from employees where salary > 6000 and (commission_pct < 0.2 or commission_pct is null);

-- 43.	Write a query to display employees whose hire date is within the last 10 years.
select * from employees where (year(hire_date) > 2015);
...
select * from employees where (salary between 3000 and 10000) and salary <> 7000;
...
select job_id, min(salary) as min_salary, max(salary) as max_salary from employees group by job_id having (min(salary) > 5000) or (max(salary) < 15000) order by min_salary asc; 

-- 51.	Write a query to find jobs where the minimum salary is at least half of the maximum salary.
select job_id, min(salary) as min_salary, max(salary) as max_salary from employees group by job_id having min(salary) >= (max(salary)/2);
